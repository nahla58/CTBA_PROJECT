...
class BulletinCreate(BaseModel):
    ...
    regions: List[str] = Field(..., description="Regions to send to")
    ...
    created_by: str = Field(..., description="Analyst who created this bulletin")
...
class BulletinPreviewResponse(BaseModel):
    ...
    title: str
    body: Optional[str]
    recipient_counts: Dict[str, int]  # Region -> count
